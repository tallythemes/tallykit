<?php
class tallykit_FrontPage_block_option_people_slideshow{
	public $section;
	public $section_name;
	public $prefix;
	
	function __construct(){
		$this->section = 'home_page_people_slideshow';
		$this->section_name = 'Home People Slider';
	...
	function options($custom_settings){
		...
		$custom_settings['settings'][] = array(
			...
			'label'       => __('Enable People Slider', 'tallykit_taxdomain'),
			'desc'        => '',
