<?php
class tallykit_FrontPage_block_output_people_slideshow{
	public $prefix;
	
	function __construct(){
		$this->prefix = 'home_page_people_slideshow_';
	}
