<?php
class tallykit_FrontPage_block_option_portfolio_carousel{
	public $section;
	public $section_name;
	public $prefix;
	
	function __construct(){
		$this->section = 'home_page_portfolio_carousel';
		$this->section_name = 'Home Portfolio Carousel';
	...
	function options($custom_settings){
		...
		$custom_settings['settings'][] = array(
			...
			'label'       => __('Enable Portfolio Carousel', 'tallykit_taxdomain'),
			'desc'        => '',
