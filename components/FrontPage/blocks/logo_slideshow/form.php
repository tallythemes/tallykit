<?php
class tallykit_FrontPage_block_option_logo_slideshow{
	public $section;
	public $section_name;
	public $prefix;
	
	function __construct(){
		$this->section = 'home_page_logo_slideshow';
		$this->section_name = 'Home Logo Slider';
		$this->prefix = 'home_page_logo_slideshow_';
	...
	function options($custom_settings){
		...
		$custom_settings['settings'][] = array(
			...
			'label'       => __('Enable Logo Slider', 'tallykit_taxdomain'),
			'desc'        => '',
