<?php
class tallykit_FrontPage_block_option_people_carousel{
	public $section;
	public $section_name;
	public $prefix;
	
	function __construct(){
		$this->section = 'home_page_people_carousel';
		$this->section_name = 'Home People Carousel';
		$this->prefix = 'home_page_people_carousel_';
	...
	function options($custom_settings){
		...
		$custom_settings['settings'][] = array(
			...
			'label'       => __('Enable People Carousel', 'tallykit_taxdomain'),
			'desc'        => '',
		...
		$custom_settings['settings'][] = array(
			...
			'desc'        => '',
			'std'         => tally_option_std($this->prefix.'direction_nav'),
			'type'        => 'select',
			'section'     => $this->section,
			'rows'        => '',
			'post_type'   => '',
