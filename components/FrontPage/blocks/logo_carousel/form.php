<?php
class tallykit_FrontPage_block_option_logo_carousel{
	public $section;
	public $section_name;
	public $prefix;
	
	function __construct(){
		$this->section = 'home_page_logo_carousel';
		$this->section_name = 'Home Logo Carousel';
	...
	function options($custom_settings){
		...
		$custom_settings['settings'][] = array(
			...
			'label'       => __('Enable Logo Carousel', 'tallykit_taxdomain'),
			'desc'        => '',
